...
namespace ft
{
    ...
    > class vector {
        ...
        private:
            ...
            template<typename _InputIterator, typename U>
            ...
            */
            ...
            template<typename _Integer>
            void _M_assign_dispatch(_Integer __n, _Integer __val, ft::true_type, ft::true_type)
            {
                #ifdef FT_DEBUG_VERBOSE
            ...
            void _M_assign_dispatch(
                _InputIterator __first, _InputIterator __last, ft::false_type, U)
            {
                #ifdef FT_DEBUG_VERBOSE
                std::cout << 
            ...
            void _M_insert_dispatch(iterator __pos, _InputIterator __first, 
                _InputIterator __last, ft::false_type, U) {
        ...
        public:
            ...
            vector(_InputIterator __first, _InputIterator __last,
                ...
                */
                ...
                _M_initialize_dispatch(
                    ...
                    ft::is_same<_InputIterator, value_type>()
                );
            }
            ...
            void assign(_InputIterator __first, _InputIterator __last)
            {
                ...
                /* big comment
                    ...
                    This is actually BROKEN in gcc's STL, if you have a vector
                        of classes constructible with integers, and you pass an
                        integer to those functions, it will actually create an element
                        by passing this int to it's int constructor and copy it

                    Those functions are only supposed to copy, and not construct
                        anything in any other way, this int constructor is called due
                        to a side effect in the implementation, the behaviour is 
                        actually undefined and should never compile in any modern
                        std lib, it does and some people use it thinking it's a feature
                        (this tester for example https://github.com/Mazoise/42TESTERS-CONTAINERS/blob/master/VECTOR/mains/mazoise_main.cpp
